...
public class Turret : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (m_fireTime >= m_fireRate)
        {
            ...
            Quaternion rotation = Quaternion.Euler(0.0f, 120.0f, 0.0f);
            GameObject cartridge = Instantiate(m_cartridge, m_cartridgePoint.position, transform.rotation * rotation, m_cartridgePoint);
            Destroy(cartridge, 4.0f);
        }
    }
